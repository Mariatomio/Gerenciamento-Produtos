...
$sql = "UPDATE categoria SET nomeCat = ? WHERE id = ?";
...
mysqli_stmt_bind_param($stmt, 'si', $nomeCat, $id);
...
if (mysqli_stmt_execute($stmt)) {
    ...
    const mensagem = "Categoria editada";
    const redirectToPage = `/produtos_listacategoria.php`;
